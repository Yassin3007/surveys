...
<div class="wrapper" >
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-right: 0;padding-bottom: 20px">
    <!-- Left navbar links -->
    <ul class="navbar-nav">


      <li class="nav-item  d-sm-inline-block">
        <a href="#" class="nav-link logout">{{auth('teachers')->user()->name}}</a>
      </li>
    </ul>
...
{{--      </div>--}}
      ...
      <ul class="navbar-nav mr-auto-navbav">
          <li class="nav-item  d-sm-inline-block">
              <a href="{{route('teacher_logout')}}" class="nav-link logout">تسجيل الخروج </a>
          </li>
          <li class="nav-item  d-sm-inline-block">
